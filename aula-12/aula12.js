...
//função toogle
const toogleClasse = (toogle) => toogle.classList.contains("hide") ? toogle.classList.remove("hide") : toogle.classList.add("hide") // aula 12
...
//função comprar
function comprar(id) {
    let { innerText: nome } = document.getElementsByTagName("h4")[id] // aula 12
    ...
    let totalPedido = arrayTotal.reduce((total, numeroAtual) => total + numeroAtual)
    ...
    adicionarLinha.append(...[adicionarItem, adicionarProduto, adicionarQuantidade, adicionarPrecoUn, adicionarTotal, adicionarBotao]) // aula 12
...
function pedidoCarrinho() {
    ...
    for (let i = 0; i < produtos.length; i++) {
        ...
        adicionarInfo.append(...[adicionarProduto, adicionarQuantidade, adicionarTotalUnitario]) //aula 12
